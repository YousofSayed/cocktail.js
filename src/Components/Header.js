    ...
    return ( /*html*/`
        <header class="px-3 py-3 flex justify-between bg-slate-200">
            ...
            <ul class="links flex gap-4 items-center">
                ...
                <c-a class="font-bold hover:text-red-500 transition-all"  to="/about/12?where=home&name=yousef">About</c-a>
                <c-a class="font-bold hover:text-red-500 transition-all" to="/ourProjs">OurProjs</c-a>
                <c-a to="/nes">nested</c-a>
                <c-a class="font-bold hover:text-red-500 hover:bg-slate-800 hover:p-3 transition-all" href="#" to="/about/12/jo">Contact us</c-a>
            </ul>
        </header>
    ` );
}
